...
--
-- Хост: 127.0.0.1:3307
-- Время создания: Ноя 05 2019 г., 13:52
...
(95, 'Vetal', 1, 'Чаша-толкушка', 500, '81'),
(109, 'Vetal', 2, 'Светильник серый', 1000, '81'),
(110, 'Vetal', 3, 'Cтул белый', 1200, '81');
...
(10, 'Камень декоративный', 'гранит', 1100, 1),
(11, 'Горшок Декоративный', 'Белый глянцевый', 8700, 1),
(12, 'Кукуруза', 'Бондюэль', 150, 1);
...
(81, 'Vetal', 2700, '2019-10-29 14:43:46', 'ОК');
...
--
ALTER TABLE `orders1`
  MODIFY `id_order` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
